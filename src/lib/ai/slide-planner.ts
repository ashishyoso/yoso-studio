...
function plannerSystem(k: ClientKnowledge): string {
  return [
    ...
    `- Body: one idea per line, generous breaks, second person about the parent ("your mother", "she won't feel it").`,
  ...
  return {
    ...
    slides: [
      ...
      },
      {
        ...
        body: [
          { text: 'It is built and broken down every single day.', highlight: 'none' },
          { text: 'Protein from food tips the balance toward building.', highlight: 'none' },
          { text: 'After 50, the muscle resists that signal — it needs more.', highlight: 'topic' },
        ],
        checkTitle: null, checkItems: null, helpsTitle: null, helpsItems: null,
        commentKeyword: null, offer: null,
      ...
      },
      {
        ...
        body: [
          { text: 'The loss is silent — there is no pain to warn you.', highlight: 'none' },
          { text: 'Often the first symptom is a fall (Cruz-Jentoft et al., Lancet, 2019).', highlight: 'topic' },
        ],
        checkTitle: null, checkItems: null, helpsTitle: null, helpsItems: null,
        commentKeyword: null, offer: null,
      ...
      },
      {
        ...
        body: [
          { text: 'Dal and rice feed the meal but leave a protein gap.', highlight: 'none' },
          { text: 'Over 70% of older adults fall short of the daily target (ICMR-NIN).', highlight: 'topic' },
        ],
        checkTitle: null, checkItems: null, helpsTitle: null, helpsItems: null,
        commentKeyword: null, offer: null,
